...
using Project.AdvertisementApp.DataAccess.EntityConfigurations;
...
namespace Project.AdvertisementApp.DataAccess.Contexts
{
    public class AdvertisementContext:DbContext
    {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(AdvetisementConfiguration).Assembly);
